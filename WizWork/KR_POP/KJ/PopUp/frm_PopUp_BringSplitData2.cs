...
//*******************************************************************************
//프로그램명    frm_PopUp_BringSplitData2.cs
//메뉴ID        
//설명          frm_PopUp_BringSplitData2 메인소스입니다.
//작성일        2020.03.09
//개발자        허윤구
//*******************************************************************************
...
namespace WizWork
{
    public partial class frm_PopUp_BringSplitData2 : Form
    {      
        ...
        string Wh_Ar_InstID = string.Empty;
        ...
        public frm_PopUp_BringSplitData2()
        {
            InitializeComponent();
            SetScreen();  //TLP 사이즈 조정
        }
        public frm_PopUp_BringSplitData2(string ArticleID)
        {
            InitializeComponent();
        ...
        public frm_PopUp_BringSplitData2(string ArticleID, string BuyerArticleNo, string InstID) //2021-07-01
        {
            InitializeComponent();
            Wh_Ar_ArticleID = ArticleID;
            Wh_Ar_BuyerArticleNo = BuyerArticleNo;
            Wh_Ar_InstID = InstID; //2021-07-01
        ...
        // 로드 이벤트.
        private void frm_PopUp_BringSplitData2_Load(object sender, EventArgs e)
        {
            // 1. 일단 클리어.
            SetFormDataClear();
        ...
        private void InitGridData()
        {
            ...
            GridData.Columns[i].HeaderText = "라벨";
            ...
            GridData.Columns[i].Name = "MachineID";
            GridData.Columns[i].HeaderText = "호기";
        ...
        private void Form_Activate()
        {
            ...
            sqlParameter.Add("InstID", Wh_Ar_InstID); //2021-07-01
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    GridData.Rows.Add(
                                        ...
                                        Lib.CheckNull(dr["MachineNo"].ToString()),
            ...
            if (Frm_tprc_Main.list_g_tsplit.Count > 0)
            {
                ...
                foreach (TSplit TS in Frm_tprc_Main.list_g_tsplit)
                {
                    ...
                    for (int k = 0; k < GridData.Rows.Count; k++)
                    {
                        ...
                        {
                            GridData.CurrentCell = GridData.Rows[k].Cells[0];
                            break;
                        }
        ...
        private void setResetButton()
        {
            if (Frm_tprc_Main.list_g_tsplit.Count <= 0)
            {
                tlpBottomChoice.ColumnStyles[0].Width = 5;
                tlpBottomChoice.ColumnStyles[1].Width = 30;
                tlpBottomChoice.ColumnStyles[2].Width = 10;
                tlpBottomChoice.ColumnStyles[3].Width = 0;
                tlpBottomChoice.ColumnStyles[4].Width = 0;
                tlpBottomChoice.ColumnStyles[5].Width = 30;
                tlpBottomChoice.ColumnStyles[6].Width = 5;
            }
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    float.TryParse(GridData.SelectedRows[0].Cells["JobID"].Value.ToString(), out JobID);
                    double.TryParse(GridData.SelectedRows[0].Cells["Qty"].Value.ToString(), out Qty);

                    Frm_tprc_Main.list_g_tsplit.Add(new TSplit());
                    Frm_tprc_Main.list_g_tsplit[0].JobID = JobID;
                    Frm_tprc_Main.list_g_tsplit[0].LabelID = Lib.CheckNull(GridData.SelectedRows[0].Cells["LabelID"].Value.ToString());
                    Frm_tprc_Main.list_g_tsplit[0].ArticleID = Lib.CheckNull(GridData.SelectedRows[0].Cells["ArticleID"].Value.ToString());
                    Frm_tprc_Main.list_g_tsplit[0].PersonID = Lib.CheckNull(GridData.SelectedRows[0].Cells["WorkPersonID"].Value.ToString());
                    Frm_tprc_Main.list_g_tsplit[0].Qty = Qty;

                    Frm_tprc_Main.list_g_tsplit[0].InstID = Lib.CheckNull(GridData.SelectedRows[0].Cells["InstID"].Value.ToString());
                }
        ...
        private void GridData_SelectionChanged(object sender, EventArgs e)
        {
            if (GridData.SelectedRows.Count > 0)
            {
                txtLabelID.Text = Lib.CheckNull(GridData.SelectedRows[0].Cells["LabelID"].Value.ToString());
                txtTotalQty.Text = Lib.CheckNull(GridData.SelectedRows[0].Cells["Qty"].Value.ToString());
            }
        }
