...
namespace WizWork
{
    public partial class frm_PopUp_PreScanWork6 : Form
    {
        ...
        public frm_PopUp_PreScanWork6()
        {
            InitializeComponent();
            SetScreen();  //TLP 사이즈 조정
        }
        public frm_PopUp_PreScanWork6(string strProcessID, string strMachineID, string strMoldID)
        {
            InitializeComponent();
        ...
        public frm_PopUp_PreScanWork6(string strProcessID, string strMachineID, string strMoldID, List<ChildLabel> lstChildLabel)
        {
            InitializeComponent();
