...
using System.Net;
using System.Text;
using System.Web; //2021-03-29 참조 -> 참조 추가 -> 어셈블리 -> System.Web 추가
	...
	public class FTP_EX
	{
		...
		public bool download(string remoteFile, string localFile)
		{
			try
			{
                ...
                string url = HttpUtility.UrlEncode("#"); //2021-03-29 주석 해제
                url = remoteFile.Replace("#", url);     //2021-03-29 주석 해제

				ftpRequest = (FtpWebRequest)FtpWebRequest.Create(host + "/" + url); //2021-03-29 주석 해제
                //ftpRequest = (FtpWebRequest)FtpWebRequest.Create(host + "/" + remoteFile); 2021-03-29 # 없을때 이거 써도 되는 듯
