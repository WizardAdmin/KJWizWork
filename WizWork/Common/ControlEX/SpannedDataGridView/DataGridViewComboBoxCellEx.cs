...
//*******************************************************************************
//프로그램명    DataGridViewComboBoxCellEx.cs
//메뉴ID        
//설명          DataGridViewComboBoxCellEx
//작성일        2012.12.06
//개발자        남인호
//*******************************************************************************
...
namespace KR_POP.Common.ControlEX
{
            ...
            if (DataGridView != null)
            {
                ...
                foreach (int rowIndex in Enumerable.Range(RowIndex, m_RowSpan))
                    foreach (int columnIndex in Enumerable.Range(ColumnIndex, m_ColumnSpan))
                    {
                        ...
                        {
                            var span = DataGridView[columnIndex, rowIndex] as ISpannedCell;
    ...
    public class DataGridViewComboBoxColumnEx : DataGridViewColumn  //DataGridViewComboBoxColumn
    {
        #region ctor
        public DataGridViewComboBoxColumnEx()
            : base(new DataGridViewComboBoxCellEx())
        {
        } 
        #endregion
        ...
        {
            get { return (this.CellTemplate as DataGridViewComboBoxCellEx).ValueMember; }
            set { (this.CellTemplate as DataGridViewComboBoxCellEx).ValueMember = value; }
        }

        public string DisplayMember
        {
            get { return (this.CellTemplate as DataGridViewComboBoxCellEx).DisplayMember; }
            set { (this.CellTemplate as DataGridViewComboBoxCellEx).DisplayMember = value; }
        }

        public object DataSource
        {
            get { return (this.CellTemplate as DataGridViewComboBoxCellEx).DataSource; }
            set { (this.CellTemplate as DataGridViewComboBoxCellEx).DataSource = value; }
        }
