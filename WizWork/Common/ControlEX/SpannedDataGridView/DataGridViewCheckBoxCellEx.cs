...
//*******************************************************************************
//프로그램명    DataGridViewCheckBoxCellEx.cs
//메뉴ID        
//설명          DataGridViewCheckBoxCellEx
//작성일        2012.12.06
//개발자        남인호
//*******************************************************************************
...
{
    public class DataGridViewCheckBoxCellEx : DataGridViewCheckBoxCell, ISpannedCell
    {
        #region Fields
        ...
        protected override Rectangle BorderWidths(DataGridViewAdvancedBorderStyle advancedBorderStyle)
        {
            ...
            var rightBottomCell = DataGridView[
                ...
                RowIndex + RowSpan - 1] as DataGridViewCheckBoxCellEx;
    ...
    public class DataGridViewCheckBoxColumnEx : DataGridViewCheckBoxColumn
    {
        ...
        public DataGridViewCheckBoxColumnEx()
            //: base(new DataGridViewCheckBoxCellEx())
        {
        } 
        #endregion
    }
